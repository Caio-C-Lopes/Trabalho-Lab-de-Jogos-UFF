...
def jogar_1_5(coins, barra_per, musica_level_before_loop):
    janela = Window(950, 594)
    janela.set_title("Before I Die")
    ...
    # Inimigos
    # escorpiao
    scorpion = Sprite("Walk_verde.png", 3)
    ...
    # levels#
    level1_5 = GameImage("fundo1_5.png")
    ...
    while True:
        ...
        if barra <= 3:
        ...
        else: # box de vida se pegar, recupera a vida total, escorpião morto
            ...
            if idle.x >= janela.width - idle.width + 140:
                jogar_1_8(coins, barra_p, musica_level_before_loop)
